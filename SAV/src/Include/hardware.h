 ...
 * Ultrasonic
 *********************************************************************************************/
#define ULTRA_1_PIN							GPIO_Pin_8 //8 for dev, 5 for final
...
#define ULTRA_EXTI_PINSOURCE_1				EXTI_PinSource8 //8 for dev, 5 for final
...
#define ULTRA_EXTI_LINE_1					EXTI_Line8 //8 for dev, 5 for final
